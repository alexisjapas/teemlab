...
//!   - `scenarios/examples/mlp_evolved.ron` — a **self-contained** showcase: the
...
fn main() {
    ...
    let scenario = args
        .get(1)
        .cloned()
        .unwrap_or_else(|| "scenarios/examples/mlp_train.ron".into());
...
// GENERATED by `cargo run --bin train` — do not hand-edit; re-run to regenerate.\n";
    std::fs::write(
        "scenarios/examples/mlp_evolved.ron",
        format!(
            "{evolved_header}{}",
...
// GENERATED by `cargo run --bin train` — do not hand-edit; re-run to regenerate.\n";
    ...
    println!(
        "wrote species/examples/mlp_trained.ron + scenarios/examples/mlp_evolved.ron + \
         scenarios/examples/mlp_brain.ron"
    );
}
