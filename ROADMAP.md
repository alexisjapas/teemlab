...
| Layer | Choice | Note |
|---|---|---|
| ECS / engine | **Bevy 0.18** | suited to heavy simulations |
| Physics | **Avian 0.6** | Bevy-native; collisions **and** occlusion raycasting |
| HUD / curves | **bevy_egui** | population, trait drift in real time |
