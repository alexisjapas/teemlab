...
[teemlab](./introduction.md)

- [Getting started](./getting-started.md)

# The model

- [The agent loop](./model/the-loop.md)
- [Genes & the genotype](./model/genes.md)
- [Brains](./model/brains.md)
...
- [The scenario crescendo](./scenarios.md)
- [Scenario file format](./scenario-format.md)
- [The editor](./editor.md)
- [Recording videos](./recording.md)
